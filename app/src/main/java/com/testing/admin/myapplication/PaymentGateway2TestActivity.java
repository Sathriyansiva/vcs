 ...
 */
public class PaymentGateway2TestActivity extends ActionBarActivity {
    ...
    */
    ...
    // Final Variables
    private String mMerchantKey = "OygoFs";
    private String mSalt = "BV1QBwCv";
    private String mBaseURL = "https://test.payu.in";
    ...
    private String mProductInfo = "Wallet"; //Passing String only
...
//            mAmount = bundle.getDouble("amount");
            ...
            mAmount = Double.parseDouble(amt);
            mPhone = bundle.getString("phone");
            mId = bundle.getInt("id");
//            isFromOrder = bundle.getBoolean("isFromOrder");
            String test = bundle.getString("isFromOrder");
            isFromOrder=test.equals("true");

//            Log.i(TAG, "" + mFirstName + " : " + mEmailId + " : " + mAmount + " : " + mPhone);
            Toast.makeText(PaymentGateway2TestActivity.this,amt + test, Toast.LENGTH_SHORT).show();
            /**
            ...
            webView.setWebViewClient(new WebViewClient() {
                ...
                public void onPageFinished(WebView view, String url) {
                    ...
                    if (url.equals(mSuccessUrl)) {
                        Intent intent = new Intent(PaymentGateway2TestActivity.this, Payment2TestActivity.class);
...
//                        intent.putExtra("isFromOrder", isFromOrder);
            ...
            webView.addJavascriptInterface(new PayUJavaScriptInterface(PaymentGateway2TestActivity.this), "PayUMoney");
    ...
    private void onPressingBack() {
        ...
        if(isFromOrder)
            intent = new Intent(PaymentGateway2TestActivity.this, Payment2TestActivity.class);
        else
            intent = new Intent(PaymentGateway2TestActivity.this, Payment2TestActivity.class);

        intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);

        AlertDialog.Builder alertDialog = new AlertDialog.Builder(PaymentGateway2TestActivity.this);
    ...
    public class PayUJavaScriptInterface {
        ...
        public void success(long id, final String paymentId) {
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    mHandler = null;
                    Toast.makeText(PaymentGateway2TestActivity.this, "Payment Successfully.", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }

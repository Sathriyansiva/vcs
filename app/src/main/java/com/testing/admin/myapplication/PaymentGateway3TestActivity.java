 ...
 */
public class PaymentGateway3TestActivity extends AppCompatActivity {
     ...
     */
    int mId;
    private String mMerchantKey = "OygoFs";//For merchant and salt key you need to contact payu money tech support otherwise you get error
    private String mSalt = "BV1QBwCv";//copy and paste works fine
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            String st = bundle.getString("isFromOrder");
            isFromOrder = st.equals("true");

            Toast.makeText(PaymentGateway3TestActivity.this, "" + mFirstName + " : " + mEmailId + " : " + mAmount + " : " + mPhone+ " : " + isFromOrder,Toast.LENGTH_SHORT).show();
            ...
            webView.setWebViewClient(new WebViewClient() {
                ...
                public void onPageFinished(WebView view, String url) {
                    ...
                    if (url.equals(mSuccessUrl)) {
                        ...
                        Intent intent = new Intent(PaymentGateway3TestActivity.this, Payment3TestActivity.class);
...
//                        intent.putExtra("isFromOrder", isFromOrder);
            ...
            webView.addJavascriptInterface(new PayUJavaScriptInterface(PaymentGateway3TestActivity.this), "PayUMoney");
    ...
    private void onPressingBack() {
        final Intent intent;
        if (isFromOrder)
            intent = new Intent(PaymentGateway3TestActivity.this, Payment3TestActivity.class);
        else
            intent = new Intent(PaymentGateway3TestActivity.this, Payment3TestActivity.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(PaymentGateway3TestActivity.this);
        ...
        public void success(long id, final String paymentId) {
            ...
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    mHandler = null;
                    Toast.makeText(PaymentGateway3TestActivity.this, "Payment Successfully.", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(PaymentGateway3TestActivity.this, MainActivity.class);

 ...
 */
public class PaymentGateway4TestActivity extends Activity {

    private ArrayList<String> post_val = new ArrayList<String>();
    private String post_Data="";
    WebView webView ;
    final Activity activity = this;
    private String tag = "PaymentGateway4TestActivity";
...
//    String salt="ZhraT96O"; // live
   ...
   public boolean shouldOverrideUrlLoading(WebView view, String url) {
    ...
    return false;
        ...
        mapParams.put("hash",PaymentGateway4TestActivity.this.hash);
        mapParams.put("txnid",(empty(PaymentGateway4TestActivity.this.params.get("txnid"))) ? "" : PaymentGateway4TestActivity.this.params.get("txnid"));
        Log.d(tag, "txnid: "+PaymentGateway4TestActivity.this.params.get("txnid"));
        mapParams.put("service_provider","payu_paisa");

        mapParams.put("amount",(empty(PaymentGateway4TestActivity.this.params.get("amount"))) ? "" : PaymentGateway4TestActivity.this.params.get("amount"));
        mapParams.put("firstname",(empty(PaymentGateway4TestActivity.this.params.get("firstname"))) ? "" : PaymentGateway4TestActivity.this.params.get("firstname"));
        mapParams.put("email",(empty(PaymentGateway4TestActivity.this.params.get("email"))) ? "" : PaymentGateway4TestActivity.this.params.get("email"));
        mapParams.put("phone",(empty(PaymentGateway4TestActivity.this.params.get("phone"))) ? "" : PaymentGateway4TestActivity.this.params.get("phone"));

        mapParams.put("productinfo",(empty(PaymentGateway4TestActivity.this.params.get("productinfo"))) ? "" : PaymentGateway4TestActivity.this.params.get("productinfo"));
        mapParams.put("surl",(empty(PaymentGateway4TestActivity.this.params.get("surl"))) ? "" : PaymentGateway4TestActivity.this.params.get("surl"));
        mapParams.put("furl",(empty(PaymentGateway4TestActivity.this.params.get("furl"))) ? "" : PaymentGateway4TestActivity.this.params.get("furl"));
        mapParams.put("lastname",(empty(PaymentGateway4TestActivity.this.params.get("lastname"))) ? "" : PaymentGateway4TestActivity.this.params.get("lastname"));

        mapParams.put("address1",(empty(PaymentGateway4TestActivity.this.params.get("address1"))) ? "" : PaymentGateway4TestActivity.this.params.get("address1"));
        mapParams.put("address2",(empty(PaymentGateway4TestActivity.this.params.get("address2"))) ? "" : PaymentGateway4TestActivity.this.params.get("address2"));
        mapParams.put("city",(empty(PaymentGateway4TestActivity.this.params.get("city"))) ? "" : PaymentGateway4TestActivity.this.params.get("city"));
        mapParams.put("state",(empty(PaymentGateway4TestActivity.this.params.get("state"))) ? "" : PaymentGateway4TestActivity.this.params.get("state"));

        mapParams.put("country",(empty(PaymentGateway4TestActivity.this.params.get("country"))) ? "" : PaymentGateway4TestActivity.this.params.get("country"));
        mapParams.put("zipcode",(empty(PaymentGateway4TestActivity.this.params.get("zipcode"))) ? "" : PaymentGateway4TestActivity.this.params.get("zipcode"));
        mapParams.put("udf1",(empty(PaymentGateway4TestActivity.this.params.get("udf1"))) ? "" : PaymentGateway4TestActivity.this.params.get("udf1"));
        mapParams.put("udf2",(empty(PaymentGateway4TestActivity.this.params.get("udf2"))) ? "" : PaymentGateway4TestActivity.this.params.get("udf2"));

        mapParams.put("udf3",(empty(PaymentGateway4TestActivity.this.params.get("udf3"))) ? "" : PaymentGateway4TestActivity.this.params.get("udf3"));
        mapParams.put("udf4",(empty(PaymentGateway4TestActivity.this.params.get("udf4"))) ? "" : PaymentGateway4TestActivity.this.params.get("udf4"));
        mapParams.put("udf5",(empty(PaymentGateway4TestActivity.this.params.get("udf5"))) ? "" : PaymentGateway4TestActivity.this.params.get("udf5"));
        mapParams.put("pg",(empty(PaymentGateway4TestActivity.this.params.get("pg"))) ? "" : PaymentGateway4TestActivity.this.params.get("pg"));
            ...
            mHandler.post(new Runnable() {
                public void run() {
                    mHandler = null;
                     ...
                     finish();*/
                    // new PostRechargeData().execute();
                    Intent intent=new Intent(PaymentGateway4TestActivity.this,Payment4TestActivity.class);
